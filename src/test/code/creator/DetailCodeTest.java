...
public class DetailCodeTest {

	public DetailCodeTest() {
	}
	...
	public static void main(String[] args) {
		...
		try {
			DetailCodeTest logic = new DetailCodeTest();
	...
	private static DetailCodeBean getDetailCodeBean(String line) {
		...
		bean.setDr("○".equals(arr[1]));
		bean.setReDr("○".equals(arr[2]));
		bean.setPreBr("○".equals(arr[3]));
		bean.setBr("○".equals(arr[4]));
		bean.setDetailCodeType(DetailCodeType.getDetailCodeType(arr[5]));
		bean.setTestClassName(arr[6]);
		bean.setTestMethodName(arr[7]);
